...
**Example (context):** Context: Q3 initiative [NAME], the team already saw [SOURCE], audience: leadership.

**Example (tone):** Tone: professional but clear; no “marketing fluff”; short and on point.

---

# Five steps: prompt anatomy
...
**Feedback:** evaluation leads to tighter reasoning and context.
...
# In short: what matters at work

A prompt should clearly include **role** (who you are and what you want), **context** (project, audience, what people already know), and **desired output format**. Tone alone or a very short prompt does not say what content and format you expect.
