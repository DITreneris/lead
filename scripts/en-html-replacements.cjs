...
function getEnHtmlReplacementPairs() {
  return [
    ...
    [
      ...
      'aria-label="Download lesson 1 summary as PDF (Lithuanian)"'
    ],
    ...
    [
      ...
      '<p class="cta-sub">PDF summary (Lithuanian) — take it with you. Go deeper via the program.</p>'
    ],
    [
      'aria-label="Pagrindinis veiksmas: atsisiųsk 1 pamokos santrauką PDF"',
      'aria-label="Primary action: download lesson 1 summary PDF (Lithuanian)"'
    ],
