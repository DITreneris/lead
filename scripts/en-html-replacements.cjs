...
function getEnHtmlReplacementPairs() {
  return [
    ...
    [
      '<details class="hero-faq geo-faq-anchor disclosure-chip disclosure-chip--inline" data-geo-faq="1">\n                <summary class="hero-faq__summary disclosure-chip__summary">DUK (trumpai)</summary>\n                <div class="hero-faq__panel disclosure-chip__panel">\n                    <div class="hero-faq__item"><strong>Kam tai?</strong> Komandai ir vadovui — aiškesni rezultatai.</div>\n                    <div class="hero-faq__item"><strong>Kada naudoti patikrą?</strong> Prieš siunčiant klientui ar vadovybei, kai svarbūs faktai ir tonas.</div>\n                    <div class="hero-faq__item"><strong>Ką kopijuoti?</strong> Paimk šabloną, užpildyk [laukus], paleisk, tada iteruok.</div>\n                </div>\n            </details>',
